...
export const plurumConfigSchema: OpenClawPluginConfigSchema = {
  jsonSchema: {
    type: "object",
...
export function resolveApiUrl(pluginConfig: unknown): string {
  if (pluginConfig && typeof pluginConfig === "object") {
    const v = (pluginConfig as Record<string, unknown>).apiUrl;
...
export function keyFileLocation(): string {
  return keyFilePath();
}
