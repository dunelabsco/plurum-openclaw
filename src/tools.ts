...
const GET_EXPERIENCE_REMINDER =
  "When you've finished applying this experience, call plurum_report_outcome with the id and an outcome of success/partial/failure (plus a one-line note on what you actually did). The trust score depends on outcome reports.";
...
export function createSearchTool(getClient: () => PlurumClient): AnyAgentTool {
  return {
    ...
    execute: async (_toolCallId, rawParams) => {
      ...
      if (!client.hasApiKey) {
        return textResult(
          toolErrorJson("PLURUM_API_KEY is not configured. Set it in your environment."),
        );
      }
